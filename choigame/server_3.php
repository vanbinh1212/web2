...
$flashurl = 'http://gunbachay.net/choigame/flashv55121/';
$Loginkey = 'QY-16-WAN-0668-2555555-7ROAD-dandantang-love777nguyenluucedrusdeptrai1721712';
$configflash = 'http://gunbachay.net/choigame/flashnew/config.xml';
$serverurl = 'http://gunbachay.net/';
...
$b= '<div style="text-align: center;">Chú ý: <h1>bảo trì 15 phút mới bạn quay lại sau
</h1></div>';
//exit($b);
?>
    ...
    <div class="bg-main">
        <div class="main">
            ...
            <div class="boxclick">
                                        ...
                                        <a href="http://gunbachay.net/tai-khoan/nap-the/" target="_blank" style="text-align: center;
font-weight: bold;
color: #fff;
background: #088A29;
height: 20;
...
float: left;">NẠP THẺ</a>
 ...
 <a class='bt-vipshop' href="http://gunbachay.net/tai-khoan/"
...
<a href="http://gunbachay.net/tai-khoan/cua-hang/" class="webshop" target="_blank" style="text-align: center;
font-weight: bold;
color: #fff;
background: orange;
height: 36px;
            ...
            <div class="box_username">
                <div class="wap_fix_us">
                    ...
                    <div class="wap_us_f">
                        ...
                        <div class="quanly"><i></i><a class="NapThe" href="http://gunbachay.net/tai-khoan/"  title="quản lý tài khoản">quản lý tài khoản</a></div>
                    </div>
                </div>
