...
function remoteAccount($content = null) {
	...
	switch ($content) {
		...
		case 'nap-the':
			...
			break;
		case 'luc-chien':
		$value['title'] = 'TOP Luc Chien';
		$value['content'] = 'toplc';
		break;
		case 'xem-qua-nap':
		$value['title'] = 'Xem Quà Nạp';
		$value['content'] = 'xemquanap';
		break;
		case 'xoa-ket':
		$value['title'] = 'Xóa Két Guild';
		$value['content'] = 'xoaket';
		break;
		case 'doi-gioi-tinh':
		$value['title'] = 'Đổi Giới Tính';
		$value['content'] = 'doigioitinh';
		break;
		case 'doi-ten':
		$value['title'] = 'Đổi Tên';
		$value['content'] = 'doiten';
		break;
		case 'nap-the':
			$value['title'] = 'Nạp thẻ';
			$value['content'] = 'recharge';
		...
		case 'giftcode':
			...
			break;
	    case 'duc-sine':
			$value['title'] = 'Công cụ quản lý game';
			$value['content'] = 'cedrus';
			break;
