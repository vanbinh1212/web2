...
class Trumthe247 {
	private $API_KEY = '38d354303e2339f39c0dff1c71aee6f2'; //Api Key của tài khoản quý khách trên hệ thống TRUMTHE247.COM
	private $API_SECRET = '33ceab8a9c4b6ecbdb30221979469a47'; //Api Serect của tài khoản quý khách trên hệ thống TRUMTHE247.COM
	...
	public function ChargeCard($telco, $serial, $pin, $amount, $user, $svID, $userid) { //Hàm gửi dữ liệu thẻ lên hệ thống trumthe247.com
		/*
		...
		*/
		...
		$dataPost = array( //Mảng chứa dữ liệu đẩy thẻ lên server TrumThe247.Com
			...
			'content' => $user . '-' . $svID . '-' . $userid . '-' . date("ymdhis")
		);
