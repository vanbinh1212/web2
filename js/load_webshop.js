...
SnapeWebshop = {
	...
	updateContent: function() {
		...
		for (var i = 0; i < SnapeWebshop.vars.dataWebshop.length; i++) {
			...
			shtml += '<div class="webshop-linetext">Giá: <em><b>'+$.number(SnapeWebshop.vars.dataWebshop[i].Price)+'</b></em> FCoins</div>';
	...
	showCart: function() {
		...
		lists += '<tr align="right"><td colspan="5"><b>Tổng Xu Web phải trả:</b></td><td><font color="blue"><b id="totalmoneypay_text">'+$.number(totalpay)+'</b> Xu Web</font></td></tr>';
