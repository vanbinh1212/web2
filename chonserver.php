...
<head>
	...
	<meta property="og:title" content="HtGunny.Com - Gunny Miễn Phí Đỉnh Cao">
        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?=$_config['page']['fullurl']?>">
					<img height="40" src="<?=$_config['page']['fullurl']?>/images/logofc.png" />
				</a>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="<?=$_config['page']['fullurl']?>/tai-khoan/chon-may-chu/">Chơi game</a>
                    </li>
                    <li>
				...
				<ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?=$_config['page']['fullurl']?>/tai-khoan/log-card/">Lịch sử nạp thẻ</a></li>							
...
<div class="col-md-3">
<div class="card">
  <img src="/images/gatrungthu.png" width="auto" height="129px" alt="Card image cap">
  <div class="card-body">

   <div class="ribbon"><span class="moinhat">MỚI NHẤT</span></div>

   <h5></h5>
    <p class="text-muted">Cụm máy chủ Gà Chu Tước ra mắt vào lúc 19h00 ngày 18/08</p>
	
     <a href="#" class="btn btn-warning"><span class="glyphicon glyphicon-play"></span> MÁY CHỦ : Gà Chu Tước</a>
  </div>
</div></div>
<!--div class="col-md-3">
<div class="card">
  ...
  <div class="card-body">
   ...
   <h5></h5>
    <p class="text-muted">Máy chủ Gà Heroes ra mắt vào lúc 19h00 ngày 06/07</p>
     ...
     <a href="http://play.HtGunny.Com/" class="btn btn-warning"><span class="glyphicon glyphicon-play"></span> MÁY CHỦ : Gà Heroes</a>
  </div>
</div></div-->
...
<div class="card">
  ...
  <div class="ribbon"><span class="dongnhat">ĐÔNG NHẤT</span></div>
   <h5></h5>
    ...
    <a href="http://play.HtGunny.Com/" class="btn btn-success"><span class="glyphicon glyphicon-play"></span> MÁY CHỦ : GÀ VISTA</a>
  </div>
</div></div-->
<!---div class="col-md-3">
<div class="card">
