...
if ($method == 'POST'){
	...
	$xmlName = $_GET['xml'];
	downloadFile("http://quest43.gn.zing.vn/".$xmlName.".xml", "../xml/".$xmlName.".xml");	
	...
	if ($xmlName == "itemstrengthengoodsinfo") {
		...
		//Ball Config
		downloadFile("http://quest43.gn.zing.vn/bombconfig.xml", "../xml/bombconfig.xml");	
		...
		downloadFile("http://quest43.gn.zing.vn/shopgoodsshowlist.xml", "../xml/shopgoodsshowlist.xml");	
